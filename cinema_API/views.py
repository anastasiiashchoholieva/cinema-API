...
from cinema_API.models import Genre, Actor, CinemaHall, Movie, MovieSession, Order
from cinema_API.permissions import IsAdminOrIfAuthenticatedReadOnly

from cinema_API.serializers import (
    GenreSerializer,
    ActorSerializer,
